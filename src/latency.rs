...
impl LatencyTable {
    ...
    pub fn default() -> (ret: Self)
        ensures
            ...
            spec_get(ret.entries@, Opcode::AddImm)   == 1u32,
            spec_get(ret.entries@, Opcode::Sub)      == 1u32,
            spec_get(ret.entries@, Opcode::SubImm)   == 1u32,
            ...
            spec_get(ret.entries@, Opcode::Nop)      == 0u32,
    {
        LatencyTable {
            entries: vec![
                ...
                (Opcode::FpDiv32,  4u32),
                (Opcode::FpCmp32,  4u32),
                (Opcode::FpCvt32To64, 4u32),
                (Opcode::FpCvtI32ToFp32, 4u32),
                (Opcode::FpCvtFp32ToI32, 4u32),
                (Opcode::FpAdd64,  6u32),
                (Opcode::FpSub64,  6u32),
                (Opcode::FpMul64,  6u32),
                (Opcode::FpDiv64,  6u32),
                (Opcode::FpCmp64,  6u32),
                (Opcode::FpCvt64To32, 6u32),
                (Opcode::FpCvtI64ToFp64, 6u32),
                (Opcode::FpCvtFp64ToI64, 6u32),
                (Opcode::AesEnc,   4u32),
                (Opcode::AesDec,   4u32),
                (Opcode::Nop,      0u32),
            ],
